...
int main(int argc, char *argv[]) {
	...
	if (argc < 4) {
		...
		cout << "Config file: ../resources/example/config" << endl;
		cout << "JobStatus file: ../resources/example/job_status" << endl;
		cout << "Ouput file: ../resources/example/out" << endl;
		configFilePath = "../resources/example/config";
		jobStatusFilePath =  "../resources/example/job_status";
		outputFilePath = "../resources/example/out";
	} else {
